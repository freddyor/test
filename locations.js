...
},
{
  ...
  events: [
    { date: "1644", description: "The pub was used as a hospital for wounded soldiers after the Battle of Marston Moor, in which Lord Fairfax's York parliamentarians defeated the Royalists ⚔️" }
  ]
},
{
...
},
{
  ...
  description: "",
  occupation: " ",
  tldr: "In 1974 an archaeological dig discovered a Roman ‘interval tower’, part of the old Roman fortress wall. This was one of six interval towers than ran from The Multangular Tower in Museum Gardens to St Leonard’s Place.",
  events: []
},
{
  name: "Lendal Chapel",
...
},
{
  ...
  description: "",
  occupation: "1993",
  tldr: "This building is home to Aviva insurance company. 🏢 The office has been explicitly designed to refer to the traditional architecture of York; it utilises the same local magnesian limestone as the Minster.",
  events: []
},
{
  ...
  description: "",
  occupation: "1020",
  tldr: "The church itself could date back as far as 1020 and a dedication stone inside bears an inscription saying it was built by ‘Efrard & Grim & Aese’. The bulk of the building dates to the early 13th century.",
  events: [
...
},
{
  ...
  tldr: "During the construction of many of these houses, large quantities of animal horns and bones were dug up. This is because St Saviourgate’s old name was Ketmongergate, which directly translates as ‘the street of the sellers of animal waste for fertilizer’.",
  events: []
},
{
...
},
{
  ...
  tldr: "Rear Admiral Hugh Robinson was the brother of John Robinson, Secretary to the Treasury in Lord North’s government. Admiral Robinson returned to England following the loss of his ship, only to die soon after.",
  events: []
},
{
...
},
{
  ...
  description: "",
  occupation: "C11th ",
  tldr: "Although the current building dates to the 15th century, this church was founded in the 11th century. It was originally known as ‘St Saviour in the Marsh’ due to the marshy lands in the area.",
  events: []
},
{
...
},
{
  ...
  description: "",
  occupation: " ",
  tldr: "If you look at the street sign for St Sampson’s Square, you will see it has another name. By 1250, the square was known as Thursday Market, where only traders from outside the city would come.",
  events: []
},
{
  name: "Davy Hall",
...
},
{
  ...
  description: "",
  occupation: " ",
  tldr: "For centuries, the main two markets in York were in St Sampson’s Square and Pavement. By the 1800s, the markets had grown considerably and struggled to cater for all the traders coming to the city.",
  events: []
},
{
  ...
  description: "",
  occupation: "1884",
  tldr: "This was the site of York’s main post office for 135 years, from 1884 to 2019. It also opened the city’s second telephone exchange in 1892. Local MP Rachael Maskell led a campaign to keep the post office open in 2019, but it closed anyway.",
  events: []
},
{
  name: "Banks Music",
